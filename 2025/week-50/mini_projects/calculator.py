...
color_orange = "#FF9500"
color_white = "white"  # with tkinter you can have a color just by writing the color
...
# center the window
window.update()  # update the windown with the new size dimensions
...
window_y = int((screen_width/2)-(screen_height/2))
