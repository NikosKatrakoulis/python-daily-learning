...
# Store these pizza names in a list and then use a for loop to
# print the name of each pizza. Modify your for loop to print a
# sentence using the name of the pizza, instead of printing just
# the name of the pizza. For each pizza, you should have one line
...
pizzas = ['margherita', 'funghi', 'bianco']
